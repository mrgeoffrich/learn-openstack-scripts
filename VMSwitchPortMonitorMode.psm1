...
# Downloaded from: https://github.com/cloudbase/unattended-setup-scripts/blob/master/VMSwitchPortMonitorMode.psm1
# Credit to the author Alessandro Pilotti, https://github.com/alexpilotti
